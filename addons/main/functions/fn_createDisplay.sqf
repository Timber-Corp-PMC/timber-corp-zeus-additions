...
/*
 * @todo remove this when ZEN release 1.12
 * @see https://github.com/zen-mod/ZEN/pull/616
 *
 * Author: mharis001
...
if (canSuspend) exitWith {
    [FUNC(createDisplay), _this] call CBA_fnc_directCall;
};
...
if (_saveID isEqualTo "") then {
    _saveID = ["zen_dialog_id", _title, _content, _onConfirm, _onCancel] joinString "$";
};

// Create the saved values namespace if needed
if (isNil "zen_dialog_saved") then {
    zen_dialog_saved = [] call CBA_fnc_createNamespace;
};

private _savedValues = zen_dialog_saved getVariable [_saveID, []];
...

{
    ...
    switch (_type) do {
        case "CHECKBOX": {
            ...
            _controlType = "zen_dialog_Row_Checkbox";
        };
        case "COLOR": {
            _defaultValue = [_valueInfo] param [0, [1, 1, 1], [[]], [3, 4]];
            _controlType = ["zen_dialog_Row_ColorRGB", "zen_dialog_Row_ColorRGBA"] select (count _defaultValue > 3);
        };
        case "COMBO": {
            ...
            _controlType = "zen_dialog_Row_Combo";
        ...
        case "EDIT": {
            ...
            _controlType = switch (_subType) do {
                case "MULTI": {
                    "zen_dialog_Row_EditMulti";
                };
                case "CODE": {
                    "zen_dialog_Row_EditCode";
                };
                default {
                    "zen_dialog_Row_Edit";
                };
        ...
        case "LIST": {
            ...
            _defaultValue = _values param [_defaultIndex];
            _controlType = "zen_dialog_Row_List";
        ...
        case "OWNERS": {
            ...
            _players = _players call zen_common_fnc_getPlayers;
            _tab = 0 max _tab min 2;

            _defaultValue = [_sides, _groups, _players, _tab];
            _controlType = "zen_dialog_Row_Owners";
        ...
        case "SIDES": {
            ...
            _controlType = "zen_dialog_Row_Sides";
        };
        case "SLIDER": {
            ...
            _defaultValue = _default;
            _controlType = "zen_dialog_Row_Slider";
        ...
        case "TOOLBOX": {
            ...
            _defaultValue = _default;
            _controlType = "zen_dialog_Row_Toolbox";
        ...
        case "VECTOR": {
            ...
            _controlType = ["zen_dialog_Row_VectorXY", "zen_dialog_Row_VectorXYZ"] select (count _defaultValue > 2);
        };
    };
    ...
    if (isNil "_defaultValue") then {
        diag_log format ["Wrong control type or invalid value info [%1] - could not find default value.", _typeArg];
        false breakOut "Main";
    };
...
private _display = if (is3DEN) then {
    ...
    _display3DEN createDisplay "zen_common_RscDisplayScrollbars"
} else {
    if (!createDialog "zen_common_RscDisplayScrollbars") exitWith {displayNull};
    uiNamespace getVariable ["zen_common_display)", displayNull]
};
...
_ctrlButtonOK ctrlAddEventHandler ["ButtonClick", {
    ...
    [_display, true] call zen_dialog_fnc_close;
}];
...
_ctrlButtonCancel ctrlAddEventHandler ["ButtonClick", {
    ...
    [_display, false] call zen_dialog_fnc_close;
}];
